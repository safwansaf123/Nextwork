...
Developers can add data attributes to HTML elements' opening tags to store custom data. The attribute name must start with "data-" and be at least one character long, but it can't contain uppercase letters. The attribute value can be any string. 
